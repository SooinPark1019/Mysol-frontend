...
export default function PostEditor({ postId }: PostEditorProps) {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        // Fetch post data
        const postData = await fetchPost(numericPostId);
        setPost(postData);
  ...
  }, [numericPostId, user, authLoading, router, toast]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updatePost(numericPostId, postData);
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="problemNumbers">
                  Problem Numbers (comma separated)
                </Label>
                <Input
                  id="problemNumbers"
